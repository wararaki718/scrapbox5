...
from project_template.survive.vectorizer.components import EmbarkedVectorizer
...
def vectorizer() -> Generator[EmbarkedVectorizer, None, None]:
    ...
    with patch("project_template.survive.vectorizer.components.embarked.joblib.load", return_value=vectorizer):
